...
#define STRING_CONFIG_H_AUTHOR "(Ning, Ender-3 V2 w/ BLTouch and Sprite Extruder)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 438.00 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -35, -2.30 }
